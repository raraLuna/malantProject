...
public class FileNameChange {
	...
	public static String changeth(String originalFileName, String savePath, 
			String formatStr) throws IOException {
		String renameFileName = null;
		...
		//저장 폴더에 있는 원본 파일의 파일명 바꾸기함 : java.io.File 클래스의 메소드 이용함
		File originFile = new File(savePath+ "\\"+ originalFileName);
		File renameFile = new File(savePath+ "\\"+"th_"+ renameFileName);
	...
	public static String changede(String originalFileName, String savePath, 
			String formatStr) throws IOException {
		String renameFileName = null;
		...
		//저장 폴더에 있는 원본 파일의 파일명 바꾸기함 : java.io.File 클래스의 메소드 이용함
		File originFile = new File(savePath+ "\\"+ originalFileName);
		File renameFile = new File(savePath+ "\\"+"de_" + renameFileName);
