...
/**
 * Servlet implementation class MyplantMoveupServlet
 */
@WebServlet("/mpmovemodify")
public class MyplantMoveModifyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyplantMoveModifyServlet() {
        super();
